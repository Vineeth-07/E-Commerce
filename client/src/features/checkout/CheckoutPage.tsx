import {
  ...
  const steps = ["Shipping address", "Review your order", "Demo payment"];
            ...
            {activeStep === steps.length ? (
              <>
                ...
                <Typography variant="subtitle1">
                  Your order number is #{orderNumber}. No real payment was processed,
                  no card was charged, and this checkout flow is for demo purposes only.
                </Typography>
              </>
            ) : (
              <>
